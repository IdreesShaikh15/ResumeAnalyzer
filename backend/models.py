...
class User(db.Model):
    ...
    resumes = db.relationship('Resume', back_ref='user', lazy=True)
    job_descriptions = db.relationship('JobDescription', back_ref='user', lazy=True)
...
class Resume(db.Model):
    ...
    analyses = db.relationship('AnalysisHistory', back_ref='resume', lazy=True)
...
class JobDescription(db.Model):
    ...
    analyses = db.relationship('AnalysisHistory', back_ref='job_description', lazy=True)
